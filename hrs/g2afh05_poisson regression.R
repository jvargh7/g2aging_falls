...
mi_dfs <- readRDS(paste0(path_g2a_falls_folder,"/working/g2afhrs_multiple imputation.RDS"))
...
bind_rows(
  ...
  write_csv(.,"hrs/g2afh05_coefficients for poisson regression.csv")
...
bind_rows(
  ...
  write_csv(.,"hrs/g2afh05_contrasts for poisson regression with multiple imputation.csv")
