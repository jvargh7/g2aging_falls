...
rm(hrs_unique_df,hrs_unique_svy,hrs_all_65plus,hrs_all_65plus_diagnosed_svy)
...
before_imputation <- hrs_all_65plus_control_available %>% 
...
saveRDS(mi_dfs, paste0(path_g2a_falls_folder,"/working/g2afhrs_sensitivity multiple imputation.RDS"))
