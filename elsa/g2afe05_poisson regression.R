...
mi_dfs <- readRDS(paste0(path_g2a_falls_folder,"/working/g2afelsa_multiple imputation.RDS"))

library(mice)
library(geepack)

source("elsa/g2afelsa_poisson regression equations.R")
...
bind_rows(
  ...
  write_csv(.,"elsa/g2afe05_coefficients for poisson regression.csv")
...
contrasts_m6_out = clean_mi_contrasts(model_list = overall_m6,link="geeglm log",modifier = "rxdiabi",exposure = "control_joint")

contrasts_a3_out = clean_mi_contrasts(model_list = overall_a3,link="geeglm log",modifier = "female",exposure = "control_a1c")
contrasts_b3_out = clean_mi_contrasts(model_list = overall_b3,link="geeglm log",modifier = "female",exposure = "control_bp")
contrasts_c3_out = clean_mi_contrasts(model_list = overall_c3,link="geeglm log",modifier = "female",exposure = "control_chol")
contrasts_l3_out = clean_mi_contrasts(model_list = overall_l3,link="geeglm log",modifier = "female",exposure = "control_ldl")
contrasts_j3_out = clean_mi_contrasts(model_list = overall_j3,link="geeglm log",modifier = "female",exposure = "control_joint2")
...
bind_rows(
  ...
  write_csv(.,"elsa/g2afe05_contrasts for poisson regression with multiple imputation.csv")
