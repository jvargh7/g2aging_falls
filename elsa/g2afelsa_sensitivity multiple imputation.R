...
rm(elsa_unique_df,elsa_unique_svy,elsa_all_65plus,elsa_all_65plus_diagnosed_svy)
...
proportion_vars = c("medication_bp","medication_dm","rxdiabi","rxdiabo",
                    ...
                    "control_joint","control_a1c","control_bp","control_chol","control_ldl","control_joint2"
...
before_imputation <- elsa_all_65plus_control_available %>% 
...
saveRDS(mi_dfs, paste0(path_g2a_falls_folder,"/working/g2afelsa_sensitivity multiple imputation.RDS"))
